  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="relative w-[350px] max-w-full shrink-0 rounded-2xl border border-border bg-card/60 backdrop-blur-sm px-8 py-6 md:w-[450px] transition-colors duration-300"
            key={item.name}
          >
            <blockquote>
              <div

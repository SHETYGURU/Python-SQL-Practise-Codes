...
#### 2. Sheet: `Ops - KPI Seats Offered`
*   **Marks Card (Text)**: Drag `[Seats Offered]` to Text (formatted to display as `446K`). Label it `"Seats Offered"` (`9pt`, `#64748B`) directly below.

#### 3. Sheet: `Ops - KPI Total Buses`
*   **Marks Card (Text)**: Drag `[Total Buses]` to Text (displays `11`).

#### 4. Sheet: `Ops - KPI Total Seating Capacity`
*   **Marks Card (Text)**: Drag `[Total Seating Capacity]` to Text (displays `470` using FIXED LOD). Label it `"Total Seating Capacity"` (`9pt`, `#64748B`) directly below.

#### 5. Sheet: `Ops - KPI Average Bus Capacity`
*   **Marks Card (Text)**: Drag `[Average Bus Capacity]` (or `AVG([Capacity])`) to Text (displays `42.73`). Label it `"Avg Bus Capacity"` (`9pt`, `#64748B`) directly below.
...
#### 4. Sheet: `Finance - KPI Repeat Customers`
*   **Marks Card (Text)**: Drag `[Repeat Customers]` to Text (displays as `220`). Label it `"Repeat Customers"` (`9pt`, `#64748B`) directly below.
